...
class DecodeStrategy(object):
    ...
    def __init__(self, pad, bos, eos, batch_size, parallel_paths,
        ...
        self.min_length = min_length#0

        #print("self.min_length:{}".format(self.min_length))

        self.max_length = max_length

        self.block_ngram_repeat = block_ngram_repeat#0
    ...
    def ensure_min_length(self, log_probs):
        #print("check if len <= self.min_length")
        if len(self) <= self.min_length:
            print("yes, len <= self.min_length")
    ...
    def block_ngram_repeats(self, log_probs):
        ...
        #print("1block_ngram_repeat: {}".format(self.block_ngram_repeat))
        if self.block_ngram_repeat <= 0:#True
            #print("2block_ngram_repeat: {}".format(self.block_ngram_repeat))
            return
        print("3block_ngram_repeat: {}".format(self.block_ngram_repeat))
