...
class PenaltyBuilder(object):
    ...
    def __init__(self, cov_pen, length_pen):
        self.has_cov_pen = not self._pen_is_none(cov_pen)# -> False
        #print('self.has_cov_pen:{}'.format(self.has_cov_pen))
        self.coverage_penalty = self._coverage_penalty(cov_pen)# -> self.coverage_none
        #print('self.coverage_penalty:{}'.format(self.coverage_penalty))
        self.has_len_pen = not self._pen_is_none(length_pen)# -> False
        self.length_penalty = self._length_penalty(length_pen)# -> self.length_none
        #print("self.length_none:{}".format(self.length_none))
