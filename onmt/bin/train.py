...
def train(opt):
    ...
    ArgumentParser.update_model_opts(opt)#更新默认参数
    ...
    if old_style_vocab(vocab):
        ...
        logger.info("check vocab is whether fields")
        fields = vocab
    ...
    #print("the train_iter has already been created!")

    nb_gpu = len(opt.gpu_ranks)

    if opt.world_size > 1: #False
        queues = []
